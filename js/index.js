...
function addProductToCart(_title, _price, _productImg) {
    ...
    var cartBoxContent = `<div class="flex flex-col md:flex-row md:gap-4">
      ...
      <div class="flex mt-5 mb-3 space-x-4">
        ...
        <div class="w-4/5 flex flex-col justify-between">
          <div class="w-full flex-col">
            <h3 class="font-semi text-lg">${_title}</h3>
            <p class="text-gray-500 text-sm">Large • XL </p>
            <p class="text-gray-500 text-sm"><span class="font-semi text-black">${_price}</span></p>
        ...
        <button class="remove-cart hidden md:inline bg-purple-600 hover:bg-purple-700 text-white font-medium text-sm rounded-md p-2 mt-3">
